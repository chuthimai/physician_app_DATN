...
export default function TestsPerServiceCard({dataDay, dataWeek, dataMonth, loading}: Props) {
    ...
    return (
        <Card>
            <CardHeader className="flex justify-between items-center">
                <CardTitle>
                    Số xét nghiệm theo dịch vụ {filter === "day" ? "(trong ngày)" : filter === "week" ? "(trong tuần)" : "(trong tháng)"}
                </CardTitle>
