...
import {
    ...
    diseaseGroups,
    prescriptionsDaily,
} from "@/fakedata/doctorStatsData.ts";
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card>
                    ...
                    <CardContent className="text-4xl font-bold">47</CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent className="text-4xl font-bold">32</CardContent>
                </Card>
            </div>
